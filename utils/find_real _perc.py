...
with open("tests/mmodel/havana_all_connections/havana_network_workers_move_from_wPop.json", 'r') as f:
    ...
    f.close()
with open("tests/mmodel/havana_all_connections/havana_network_correct_perc.json", 'w') as f:
