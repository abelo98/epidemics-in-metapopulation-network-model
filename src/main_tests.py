...
def main():
    ...
    label1 = 'I(t) SIR clasico todos los municipios conectados'
    label2 = 'I(t) SIR metapoblaciones todos los municipios conectados'
    # run_test()
    compare_est_with_org(y_estimated, y_estimated2)
    plot_est_and_original(y_estimated, y_estimated2, label1, label2)
